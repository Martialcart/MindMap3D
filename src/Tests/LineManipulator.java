...
public class LineManipulator extends Application {
    ...
    @Override public void start(final Stage stage) throws Exception {
        ...
        DoubleProperty startZ = new SimpleDoubleProperty(100);
        DoubleProperty endX   = new SimpleDoubleProperty(300);
        DoubleProperty endY   = new SimpleDoubleProperty(200);
        DoubleProperty endZ   = new SimpleDoubleProperty(200);
        ...
        stage.setScene(new Scene(new Group(line, start, end), 400, 400,true));
        stage.show();
    }
